  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[9rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-sm shadow-xl",
          className,
        )}
      >
                      ...
                      {itemConfig?.icon ? (
                        ...
                        !hideIndicator && (
                          <div
                            ...
                            style={{
                              backgroundColor: indicatorColor, // هون المتصفح رح يقرأ oklch(...) مباشرة
